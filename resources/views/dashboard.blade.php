...
<head>
    ...
    <!--style media="screen">
        ...
        .menu-categories .menu:hover .submenu {
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="main-container" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
