...
@section('dashboard_breadcum')
  ...
  <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Chairman Profile</a></li>
@endsection
@section('dashboard_content')
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <form action="{!! route('dashboard.who-we-are.chairman.update') !!}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="widget-content widget-content-area br-6">
        ...
        <div class="table-responsive mb-4 mt-4">
          ...
          <div class="d-flex">
            ...
            <div class="col-sm-6">
              <label for="">Sign Image</label>
              <input type="file" class="form-control-file mb-3" name="sign_image">
            </div>
          </div>
          <div class="col-sm-12">
