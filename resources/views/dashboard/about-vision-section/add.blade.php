...
@section('dashboard_content')
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <form action="{!! route('dashboard.reports-presentations.save') !!}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="widget-content widget-content-area br-6">
        <div class="table-responsive mb-4 mt-4">
          ...
          <button type="submit" class="btn btn-primary ml-3" name="button">Save</button>
        </div>
      </div>
    </form>
  </div>
