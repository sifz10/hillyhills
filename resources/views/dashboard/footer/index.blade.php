...
@section('dashboard_content')
  ...
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <form action="{!! route('dashboard.footer.update') !!}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="widget-content widget-content-area br-6">
        ...
        <div class="table-responsive mb-4 mt-4">
          <div class="col-sm-12">
            ...
            <input type="file" class="form-control-file mb-3" name="footer_logo">
          </div>
          <div class="col-sm-12">
            <label for="">About</label>
            <input type="text" class="form-control mb-3" name="footer_about" required value="{{ $edit->footer_about }}">
          </div>
        </div>
      </div>
      <div class="widget-content widget-content-area br-6 mt-4">
        ...
        <div class="table-responsive mb-4 mt-4">
          <div class="col-sm-12">
              <label for="">About</label>
              <input type="text" class="form-control mb-3" name="arabic_footer_about" required value="{{ $edit->arabic_footer_about }}">
          </div> 
        </div>
      </div>
