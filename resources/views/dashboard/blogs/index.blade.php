...
@section('dashboard_content')
  ...
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <form action="{!! route('blogs_save') !!}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="table-responsive mb-4 mt-4">
          <div class="d-flex">
            ...
            <div class="col-sm-4">
              ...
              <input type="date" class="form-control mb-3" name="publish_date" required value="">
            </div>
            <div class="col-sm-4">
              <label for="">Image (1910x660)</label>
              <input type="file" class="form-control-file mb-3" required name="blog_image">
            </div>
          </div>
          <div class="col-sm-12">
