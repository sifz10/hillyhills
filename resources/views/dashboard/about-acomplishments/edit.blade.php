...
@section('dashboard_content')
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <form action="{!! route('dashboard.about-acomplishments.update') !!}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="table-responsive mb-4 mt-4">
          <div class="d-flex">
            <div class="col-sm-6">
              ...
              <input type="tex" class="form-control mb-3 year_custom" name="year" required value="{{ $edit->year }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="4">
            </div>
            <div class="col-sm-6">
