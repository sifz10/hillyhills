            ...
            <div class="row m-0">
                <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                    <div class="sidebar h-100">
                        ...
                        <a href="{!! route('frontend.investors-relations.reports-presentations',[app()->getLocale()]) !!}" class="this">Reports & Presentations</a>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 bg-ligit-yell p-5">
                    <h2 class="report-title">Reports & Presentations</h2>
