        ...
        <div class="container-xxl p-0">
            <div class="row m-0">
                <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                    <div class="sidebar h-100">
                        ...
                        <div class="dropdown">
                            ...
                            <li><a class="dropdown-item text-white this" href="{!! route('frontend.investors-relations.annual-report',[app()->getLocale()]) !!}">Annual Reports</a></li>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 bg-ligit-yell p-5">
                    <h2 class="report-title">Annual Reports</h2>
