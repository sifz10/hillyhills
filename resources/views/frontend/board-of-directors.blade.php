...
<section class="splash board_diractor">
        <div class="container container-xxl">
            <h1>Board of Directors</h1>
        </div>
    </section>
    <section class="board-director-main">
        ...
        <div class="row m-0">
            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                <div class="sidebar h-100">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="{!! route('frontend.who-we-are.board-of-directors') !!}" class="active">Board of Directors</a>
                        </li>
                        <li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 bg-ligit-yell p-5">
                <div class="dir_loop mt-4">
                    <div class="chairman-name">
                        <hr>
                        <h2 class="m-0">Name & Surname</h2>
                        <h6>Chairman</h6>
                        <hr class="border-bott">
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            <img src="{{ asset('frontend/asset/img/orgnization/chairman1.jpg')}}" alt="" srcset="" class="w-100 lg-wid-auto-2">
                        </div>
