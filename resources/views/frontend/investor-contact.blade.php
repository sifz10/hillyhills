            ...
            <div class="row m-0">
                <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                    <div class="sidebar h-100">
                        ...
                        <a href="{!! route('frontend.investors-relations.investor-contact',[app()->getLocale()]) !!}" class="this">Investor Contact</a>
                        <div class="dropdown">
                            <button class="dropdown-toggle text-white p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Others
                            </button>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 bg-ligit-yell investor-conr p-5">
                    <p>For all inquiries and questions concerning investor relations,</p>
